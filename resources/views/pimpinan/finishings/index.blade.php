...
@section('title', 'SIPP | Finishing - Pimpinan')
            ...
            <div class="card-body">
                <div class="row mb-2">
                    ...
                    <div class="col-md-4 d-flex justify-content-end pb-3">
                        <a href="{{ route('pimpinan.finishings') }}" name="pimpinanoffset_cetakpdf" class="btn btn-outline-danger" role="button"><i class="fa-solid fa-print"></i> Cetak Laporan</a>
                    </div>
                </div>
                <div class="table-responsive">
                    <table class="table table-bordered table-hover nowrap" id="table-pimpinan-finishings" style="width:100%">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Konsumen</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#table-pimpinan-finishings').DataTable({
            responsive: true,
            ordering: true,
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{ route('pimpinan-finishings.index') }}",
                type: "GET",
                dataType: "JSON"
            },
            columns: [
    ...
    $(document).ready(function() {
        $('.btn-refresh').click(function(e) {
            e.preventDefault()
            $('#table-pimpinan-finishings').DataTable().ajax.reload()
        })
    });
</script>
@endsection
